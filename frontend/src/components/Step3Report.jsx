...
const Step3Report = ({ report }) => {
  ...
  advice="Significant improvement required. Focus on structured thinking, clarity and confident delivery. Practice answering alound regularly."
}
...
doc.save("AI_Interview_Report.pdf");
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gary-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8">
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 ">
        <div className="w-full flex md:mb-10 items-start gap-4 flex-wrap">
          <button
        ...
        <button onClick={downloadPDF} className="bg-emerald-600 hover:bg-emerald-700 text-white py-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm cursor-pointer sm:text-base text-nowrap">
          Download PDF
        </button>
      </div>
