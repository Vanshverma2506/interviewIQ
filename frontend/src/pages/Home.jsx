...
import configImg from "../assets/confi.png";
            ...
            <div className="grid md:grid-cols-2 gap-10">
              {[
                ...
                <motion.div
                  ...
                  className="bg-white border border-gray-200 rounded-3xl px-8 shadow-sm hover:shadow-xl transition-all"
                >
                  <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="w-full md:w-1/2">
                      <div className="bg-green-50 text-green-600 h-12 w-12 rounded-xl flex items-center justify-center mb-6">
                        {item.icon}
                      </div>
            ...
            <div className="grid md:grid-cols-2 gap-10">
              {[
                ...
                <motion.div
                  ...
                  className="bg-white border border-gray-200 rounded-3xl px-8 shadow-sm hover:shadow-xl transition-all"
                >
                  <div className="flex items-center justify-bteween gap-6">
                    <div className="w-1/2">
                    ...
                    <img src={mode.image} alt={mode.title} className="w-28 h-28 object-contain"/></div>
                  </div>
                </motion.div>
              ))}
            </div>
